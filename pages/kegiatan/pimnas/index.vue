...
<template>
  <section class="text-center">
    ...
    <div class="border border-3 border-unpad my-10 max-w-md ma" />
    <div class="bg-unpad py-2 max-w-lg ma rounded-lg">
      <h2 class="text-white font-semibold">Profil Peserta PIMNAS 36 Unpad</h2>
    </div>
    <div class="grid grid-cols-3 gap-3 my-10 rounded-lg">
      <div v-for="campus in getAllCampus" class="bg-yellow-2 rounded-xl">
        <GenericBaseCard>
          <div class="flex flex-col items-center text-center gap-2 my-5">
            ...
            <div>
              <NuxtLink
                class="btn bg-unpad py-1 text-white"
