  ...
  <section class="text-center">
    <div>
      ...
      <div class="flex items-center justify-center gap-5 my-5">
        <NuxtImg src="/images/lambang-unpad.png" class="w-24 h-24" format="webp" />
        <NuxtImg src="https://pimnas36.unpad.ac.id/wp-content/uploads/2023/09/Logo-PIMNAS-36-Unpad.png" class="h-24"
          format="webp" />
      </div>
      ...
      <div>
        <iframe class="w-full h-2xl rounded-lg"
          src="https://www.youtube-nocookie.com/embed/WG0hV-BgZj4?si=vlw9rJMJ2wk8UF8x" title="Sukseskan Pimnas 36"
          frameborder="0"
      ...
      <div class="mt-5">
        ...
        <div class="mt-5">
          <NuxtLink href="/kegiatan/pimnas/sosialisasi" class="btn bg-orange text-white py-1">
      ...
      <div v-for="campus in getAllCampus" class="bg-orange-2 rounded-xl">
        <GenericBaseCard>
          <div class="flex flex-col items-center text-center gap-2 my-5">
            <NuxtImg :src="campus.link_logo" class="w-full h-15 w-full object-contain" />
            <h6>{{ campus.nama_perguruan_tinggi }}</h6>
            <div>
              <NuxtLink class="btn bg-orange py-1 text-white" :href="'/kegiatan/pimnas/' + campus.id">
                Lihat Profil
              </NuxtLink>
            </div>
          </div>
