...
<template>
  <main>
    <div class="page-hero">
      ...
      <div class="relative z-1">
        <div class="section-badge">
          <div class="i-mdi-archive w-3.5 h-3.5" />
          Archive
        </div>
        <h1 class="page-hero-title">Berita Archive</h1>
    ...
    <div class="list-wrap">
      <template v-if="dataArtikelArchive.length > 0">
      ...
      <div v-else class="empty-state">
        <div
          ...
          style="color: #ccc"
        />
        <p>Belum ada berita mengenai Archive.</p>
      </div>
    </div>
