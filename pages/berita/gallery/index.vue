  ...
  <main>
    <div class="page-hero">
      ...
      <div class="relative z-1">
        ...
        <h1 class="page-hero-title">Berita Gallery</h1>
        <p class="page-hero-desc">
          Berita yang berkaitan seputar Galeri dan pengelolaannya.
        </p>
      </div>
    </div>

    <div class="list-wrap">
      <template v-if="dataArtikelGallery.length > 0">
        <div class="article-grid">
          <GenericArticleCard
            v-for="item in dataArtikelGallery"
            :key="item.id"
      ...
      <div v-else class="empty-state">
        <div
          ...
          style="color: #ccc"
        />
        <p>Belum ada berita mengenai Gallery.</p>
      </div>
    </div>
