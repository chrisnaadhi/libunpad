  ...
  <section>
    ...
    >
      ...
      <div class="flex flex-col items-center z-1">
        ...
        <p class="text-sm" v-show="berita[0].kategori">
        ...
        <div class="text-center">
          <p class="text-sm">
            ...
            <span
              class="italic"
              v-else-if="berita[0].tag_berita"
              v-for="tag in berita[0].tag_berita"
            >
              {{ tag }},
            </span>
          </p>
    ...
    <div class="max-w-7xl ma">
      <article>
        ...
        <span
          class="text-justify konten-berita"
