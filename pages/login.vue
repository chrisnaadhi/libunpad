...
const defaultLoginNotif = ref(
  "Login khusus Staff Kandaga, jika anda bukan staff silahkan login dengan mengklik tombol Login PAuS SSO bagian Login Mahasiswa / Dosen / Tenaga Kependidikan.",
);
