...
<template>
  <div class="modal-display">
    <Transition>
      <section class="max-w-2xl bg-white px-10 py-5 rounded-lg">
        ...
        <div v-else-if="peminjamanLokerStore.showLokerData === true && peminjamanLokerStore.isFull === false" class="show-loker-info">
          ...
          <div class="bg-red-2 w-full rounded-lg mt-5">
            ...
            <p class="info-content">Mohon untuk menjaga kunci dengan baik, jangan sampai tertinggal atau hilang! Kehilangan / Tidak mengembalikan kunci ke Petugas akan dikenai denda sebesar :</p>
